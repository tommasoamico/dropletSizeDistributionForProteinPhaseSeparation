...
# DEAD protein #
################
pathDead: str = '/Users/tommaso/Workspace/dropletSizeDistributionForProteinPhaseSeparation/data/dead/capflex_point_corr.csv'
...
# pappuA/pappuB   #
###################
pathPappuA: str = '/Users/tommaso/Workspace/dropletSizeDistributionForProteinPhaseSeparation/data/pappu/Figure4A_B_C.xlsx'
...
# pappuB       #
################
pathPappuB: str = '/Users/tommaso/Workspace/dropletSizeDistributionForProteinPhaseSeparation/data/pappu/Figure4A_B_C.xlsx'
...
criticalEstimationJoinedA: float = pd.read_csv(
    '/Users/tommaso/Workspace/dropletSizeDistributionForProteinPhaseSeparation/data/appData/fusUnfus/FUS/criticalRho/estimateExperimentJoint.csv')['rho'][0]
